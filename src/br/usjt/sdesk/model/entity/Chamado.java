...
public class Chamado {
	...
	public int getTempo() {
		 ...
		 * Quando È feita a divis„o por 1000 * 60 * 60 * 24, isso È retornado/convertido em dias
		 * */
		int dias;
		if(dataFechamento == null) {
			//Considera a datae hora do servidor para c·lculo do tempo aberto
			dias = (int)(System.currentTimeMillis() - dataAbertura.getTime())/(1000 * 60 * 60 * 24);
		}else {
			//Considera a data de fechamento para calcular o tempo que est· aberto.
